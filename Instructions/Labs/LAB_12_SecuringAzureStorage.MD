...
6. Kembali ke tab **alamat IP** pada bilah **Buat jaringan virtual**, klik **Tinjau + buat**.
...
2. Pada panel **Grup keamanan jaringan**, klik **+ Buat**.

3. Pada tab **Dasar** pada bilah **Buat grup keamanan jaringan**, tentukan pengaturan berikut: 
